...
import ru.mirea.laricheva.osmmaps.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marker2.setPosition(new GeoPoint(52.082252, 23.656178));
        marker2.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker2, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Брестская крепость - мемориал мужества", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
        mapView.getOverlays().add(marker2);
        marker2.setIcon(ResourcesCompat.getDrawable(getResources(), org.osmdroid.library.R.drawable.osm_ic_follow_me_on, null));
        marker2.setTitle("Брестская крепость");

        Marker marker3 = new Marker(mapView);
        marker3.setPosition(new GeoPoint(59.953051, 30.364074));
        marker3.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker3, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Бывший следственный изолятор \"Кресты\"", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
